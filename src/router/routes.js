...
const routes = [
  {
    ...
    children: [
      ...
      { path: ':team/:id/:iframe?', component: () => import('pages/dashboardFiles.vue'), meta: {public:true} },
      { path: ':team/:id/file/:img/:iframe?', component: () => import('pages/viewFile.vue'), meta: {public:true} },
